...
public class BitVector
{
    ...
    {
        return (0x1 << index) == (this.bits & (0x1 << index)) && index < 32;
    }
    ...
    {
        return ((0) == (this.bits & (0x1 << index))) || (index >= 32);
    }
